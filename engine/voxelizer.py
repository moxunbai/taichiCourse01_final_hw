...
@ti.data_oriented
class Voxelizer:
    def __init__(self, res, dx, super_sample=2, precision=ti.f32, padding=3):
        assert len(res) == 3
        res = list(res)
        ...
        assert precision in [ti.f32, ti.f32]
