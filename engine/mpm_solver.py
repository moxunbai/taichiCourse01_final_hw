...
class MPMSolver:
    ...
    def __init__(
        ...
        self.mesh_vetx_start = ti.field(ti.i32, shape=(10))
        self.mesh_obj_count= ti.field(ti.i32, shape=())
        self.mesh_vetx_start.fill(-1)
        self.mesh_obj_count[None] =0
        self.dx = size / res[0]
    ...
    def particle_info(self):
        ...
        np_mesh_vets_idx=self.mesh_vetx_start.to_numpy()
        ...
        return {
            ...
            'color': np_color,
            'mesh_vetx_idx':np_mesh_vets_idx
        }
