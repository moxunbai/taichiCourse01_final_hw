...
class BVHS:
    ...
    def __init__(self):
        ...
        ti.root.dense(ti.i, self.max_bvh_ele).place(self.bvh_obj_id, self.bvh_left_id,
    ...
    def clear(self):
        self.root_list = []
        self.total_count = 0
        # self.bvh_obj_id.fill(0)
        # self.bvh_left_id.fill(0)
        # self.bvh_right_id.fill(0)
        # self.bvh_next_id.fill(0)
        # self.bvh_area.fill(0.0)
        # self.bvh_min.fill(0.0)
        # self.bvh_max.fill(0.0)
